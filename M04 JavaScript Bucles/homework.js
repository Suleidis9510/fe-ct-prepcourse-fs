...
function operadoresLogicos(num1, num2, num3) {
   ...
   // Tu código:
      ...
      if (num1 > num2 && num1 > num3 && num1 > 0) {
        results.push("Numero 1 es mayor y positivo");
      }
    
      if (num1 < 0 || num2 < 0 || num3 < 0) {
        results.push("Hay negativos");
      }
    ...
    console.log(operadoresLogicos(7, 2, 3));
    console.log(operadoresLogicos(3, -1, 11));
    console.log(operadoresLogicos(3, -9, 10));
